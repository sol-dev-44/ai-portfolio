...
type QuizFeatureProps = {
    onStartChat: (breedId: string) => void;
    onAddToCompare: (breedId: string) => void;
    selectedForCompare: string[];
};

export default function QuizFeature({ onStartChat, onAddToCompare, selectedForCompare }: QuizFeatureProps) {
                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full mb-6 shadow-2xl"
                        >
                        ...
                        >
                            Answer a few questions about your lifestyle, and our AI will match you
                            with ideal dog breeds using advanced semantic search and embeddings.
                        </motion.p>
                        ...
                        >
                            <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 text-sm">
                                    Semantic search finds your best match
                                </p>
                            </div>
                            ...
                            <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                                ...
                                <p className="text-gray-600 dark:text-gray-400 text-sm">
                                    Based on your unique lifestyle
                                </p>
                            </div>
                        ...
                        <motion.button
                            ...
                            className="px-10 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all"
                        >
                            Start Quiz →
                        </motion.button>
                    </motion.div>
